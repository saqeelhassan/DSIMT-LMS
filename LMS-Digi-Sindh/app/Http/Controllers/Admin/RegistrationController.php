...
class RegistrationController extends Controller
{
    public function index(): View
    {
        ...
        return view('admin.registrations.index', compact('pendingRegistrations'));
    }
    ...
    public function approve(Request $request, User $user): RedirectResponse
    {
        ...
        AuditLog::log('registration_approved', User::class, $user->id, auth()->user()->name . " approved registration: {$user->email}");
    ...
    public function reject(Request $request, User $user): RedirectResponse
    {
        ...
        AuditLog::log('registration_rejected', User::class, $user->id, auth()->user()->name . " rejected registration: {$email}");
