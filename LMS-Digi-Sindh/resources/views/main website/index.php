...
$title = "Digital Sindh Institute | IT & Digital Skills Training in Sindh";
$description = "Join Digital Sindh Institute and boost your career with professional IT courses, diplomas, and digital skills training in Sindh. Admissions open now!";
$keywords = null;
...
?>
 ...
 <div id="mymodal" class="mymodal" tabindex="-1">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <a href="#" target="_blank">
                    <img src="assets/images/events/post.jpeg" alt="" class="w-100">
                </a>
                <div class="button wow fadeInUp mt-3" data-wow-delay=".9s">
                    <!--<a href="" class="btn">Enroll Now</a>-->
                    <a href="Admission_Form/pitp_form.php" class="btn" target="_blank">
                        Enroll Now
                    </a>
    ...
    <!-- Start Hero Area -->
     <section class="hero-area">
        <div class="hero-slider">
            <!-- Single Slider -->
             <div class="hero-inner overlay" style="background-image: url('assets/images/dsimt_imgs/wall.jpg');">
                <div class="container">
                    <div class="row ">
                            ...
                            <div class="home-slider">
                                <div class="hero-text">
                                    ...
                                    <div class="button wow fadeInUp" data-wow-delay=".9s">
                                        <a href="Admission_Form/pitp_form.php" class="btn">Enroll Now</a>
                                        <a href="courses.html" class="btn alt-btn">Our Courses</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <!--/ End Single Slider -->
            <!-- Single Slider -->
             <div class="hero-inner overlay" style="background-image: url('assets/images/dsimt_imgs/adm.png');">
                <div class="container">
                    <div class="row ">
                        <div class="col-lg-8 offset-lg-2 col-md-12 co-12">
                            <div class="home-slider">
                                <div class="hero-text">
                                    ...
                                    <div class="button wow fadeInUp" data-wow-delay=".9s">
                                        <a href="contact_us.html" class="btn">Enroll now</a>
                                        <a href="services.html" class="btn alt-btn">Our Services</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <!--/ End Single Slider -->
            <!-- Single Slider -->
             <div class="hero-inner overlay" style="background-image: url('assets/images/dsimt_imgs/wall4.jpg');">
                <div class="container">
                    <div class="row ">
                        <div class="col-lg-8 offset-lg-2 col-md-12 co-12">
                            <div class="home-slider">
                                <div class="hero-text">
                                    ...
                                    <div class="button wow fadeInUp" data-wow-delay=".9s">
                                        <a href="contact_us.html" class="btn">Enroll Now</a>
                                        <a href="perm_teachers.html" class="btn alt-btn">Our Experienced Team</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <!--                <img src="assets/images/carousel/web-development.jpeg" width="380px">-->
    <!--            </li>-->
    <!--            <li data-flip-title="Razzmatazz" data-flip-category="Purples">-->
    <!--                <img src="assets/images/carousel/python.jpeg" width="380px">-->
    <!--            </li>-->
    <!--            <li data-flip-title="Deep Lilac" data-flip-category="Purples">-->
    <!--                <img src="assets/images/carousel/graphic-designing.jpeg" width="380px">-->
    <!--            </li>-->
    <!--            <li data-flip-title="Daisy Bush" data-flip-category="Purples">-->
    <!--                <img src="assets/images/carousel/courses.jpeg" width="380px">-->
    <!--            </li>-->
    <!--            <li data-flip-title="Cerulean Blue" data-flip-category="Blues">-->
    <!--                <img src="assets/images/carousel/e-commerce.jpeg" width="380px">-->
    <!--            </li>-->
    <!--            <li data-flip-title="Dodger Blue" data-flip-category="Blues">-->
    <!--                <img src="assets/images/carousel/digital-marketing.jpeg" width="380px">-->
    <!--            </li>-->
    <!--            <li data-flip-title="Cyan" data-flip-category="Blues">-->
    <!--                <img src="assets/images/carousel/cyber-security.jpeg" width="380px">-->
    <!--            </li>-->
    <!--        </ul>-->
...
<script>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12">
                    <div class="about-right wow fadeInRight" data-wow-delay=".4s">
                        <img src="assets/images/carousel/wallpaper.gif" width="100%" alt="#">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-12 padding-zero">
                        ...
                        <div class="single-feature">
                            ...
                            <div class="button">
                                <a href="courses.html" class="btn">Visit Courses <i class="lni lni-arrow-right"></i></a>
                            </div>
                        </div>
                        <!-- End Single Feature -->
                    </div>
                    <div class="col-lg-4 col-md-4 col-12 padding-zero">
                        ...
                        <div class="single-feature">
                            ...
                            <div class="button">
                                <a href="perm_teachers.html" class="btn">Meet Trainers <i class="lni lni-arrow-right"></i></a>
                            </div>
                        </div>
                        <!-- End Single Feature -->
                    </div>
            ...
            <div class="single-head">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-course wow fadeInUp" data-wow-delay=".2s">
                            <div class="course-image">
                                <a href="contact_us.html"><img  src="assets/images/courses/PY-WD.jpg"
                                        alt="#"></a>
                                <a href="contact_us.html"><p class="price">Check Details</p></a>
                            </div>
                            <div class="content">
                                <h3><a href="contact_us.html">Web Development With Python Programming</a></h3>
                               <a href="Admission_Form/apply.php"> <button class="btn-sm enroll_now">Enroll Now</button> </a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-course wow fadeInUp" data-wow-delay=".2s">
                            <div class="course-image">
                                <a href="contact_us.html"><img class="image" src="assets/images/courses/CIT.jpg"
                                        alt="#"></a>
                                <a href="contact_us.html"><p class="price">Check Details</p></a>
                            </div>
                            <div class="content">
                                <h3><a href="contact_us.html">DIT & CIT</a></h3>
                               <a href="Admission_Form/apply.php"> <button class="btn-sm enroll_now">Enroll Now</button> </a>
                            </div>
                            <div class="bottom-content">
                                <ul class="review">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-course wow fadeInUp" data-wow-delay=".2s">
                            <div class="course-image">
                                <a href="contact_us.html"><img  src="assets/images/courses/AM.jpg"
                                        alt="#"></a>
                                <a href="contact_us.html"><p class="price">Check Details</p></a>
                            </div>
                            <div class="content">
                                <h3><a href="contact_us.html">Amazon(Virtual Assistant)</a></h3>
                               <a href="Admission_Form/apply.php"> <button class="btn-sm enroll_now">Enroll Now</button> </a>
                            </div>
                            <div class="bottom-content">
                                <ul class="review">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-course wow fadeInUp" data-wow-delay=".2s">
                            <div class="course-image">
                                <a href="contact_us.html"><img src="assets/images/courses/WD.jpg"
                                        alt="#"></a>
                                <a href="contact_us.html"><p class="price">Check Details</p></a>
                            </div>
                            <div class="content">
                                <h3><a href="contact_us.html">Web Development</a></h3>
                               <a href="Admission_Form/apply.php"> <button class="btn-sm enroll_now">Enroll Now</button> </a>
                            </div>
                            <div class="bottom-content">
                                <ul class="review">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-course wow fadeInUp" data-wow-delay=".2s">
                            <div class="course-image">
                                <a href="contact_us.html"><img  src="assets/images/courses/DM.jpg"
                                        alt="#"></a>
                                <a href="contact_us.html"><p class="price">Check Details</p></a>
                            </div>
                            <div class="content">
                                <h3><a href="contact_us.html">Digital Marketing</a></h3>
                               <a href="Admission_Form/apply.php"> <button class="btn-sm enroll_now">Enroll Now</button> </a>
                            </div>
                            <div class="bottom-content">
                                <ul class="review">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-course wow fadeInUp" data-wow-delay=".2s">
                            <div class="course-image">
                                <a href="contact_us.html"><img  src="assets/images/courses/GD.jpg"
                                        alt="#"></a>
                                <a href="contact_us.html"><p class="price">Check Details</p></a>
                            </div>
                            <div class="content">
                                <h3><a href="contact_us.html">Graphic Design</a></h3>
                               <a href="Admission_Form/apply.php"> <button class="btn-sm enroll_now">Enroll Now</button> </a>   
                            </div>
                            <div class="bottom-content">
                                <ul class="review">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-event wow fadeInUp" data-wow-delay=".2s">
                        <div class="event-image">
                            <a href="event-details.html"><img src="assets/images/dsimt_imgs/Annual.jpg" alt="#"></a>
                            <p class="date">23<span>SEPT</span><span>2024</span></p>
                        </div>
                        <div class="content">
                            <h3><a href="event-details.html">Excellence Annual Ceremony</a></h3>
                      
                            </div>
                        <div class="bottom-content">
                            <a class="speaker" href="javascript:void(0)">
                                <img src="assets/images/dsimt_imgs/news.jpg" alt="#">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-event wow fadeInUp" data-wow-delay=".2s">
                        <div class="event-image">
                            <a href="event-details.html"><img src="assets/images/dsimt_imgs/CD.jpg" alt="#"></a>
                            <p class="date">23<span>SEPT</span><span>2024</span></p>
                        </div>
                        <div class="content">
                            <h3><a href="event-details.html">Certificate Distribution Ceremony</a></h3>
                        </div>
                        <div class="bottom-content">
                            <a class="speaker" href="javascript:void(0)">
                                <img src="assets/images/dsimt_imgs/chief.jpg" alt="#">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-event wow fadeInUp" data-wow-delay=".4s">
                        <div class="event-image">
                            <a href="event-details.html"><img class="image" src="assets/images/galary/pic1.JPG" alt="#"></a>
                            <p class="date">29<span>MAY</span><span>2024</span></p>
                        </div>
                        <div class="content">
                            <h3><a href="event-details.html">Birthday Wonderland for C.E.O of DSIMT</a></h3>
                        
                            </div>
                        <div class="bottom-content">
                            <a class="speaker" href="javascript:void(0)">
                                <img src="assets/images/dsimt_imgs/lutuf.jpg" alt="#">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <!--            <div class="col-lg-5 col-12">-->
                                <!-- Image -->
                <!--                <div class="image">-->
                <!--                    <img src="assets/images/team/lutuf.jpg" alt="#Lutuf Ali Junejo">-->
                <!--                </div>-->
                                <!-- End Image -->
                <!--            </div>-->
                    ...
                    <div class="single-team wow fadeInUp" data-wow-delay=".4s">
                        <div class="row">
                            <div class="col-lg-5 col-12">
                                <!-- Image -->
                                <div class="image">
                                    <img src="assets/images/team/shafique.jpg" alt="#">
                                </div>
                                <!-- End Image -->
                            </div>
                            <div class="col-lg-7 col-12">
                    ...
                    <div class="single-team wow fadeInUp" data-wow-delay=".4s">
                        <div class="row">
                            <div class="col-lg-5 col-12">
                                <!-- Image -->
                                <div class="image">
                                    <img src="assets/images/team/sanjay.jpg" alt="#">
                                </div>
                                <!-- End Image -->
                            </div>
                            <div class="col-lg-7 col-12">
                    ...
                    <div class="single-team wow fadeInUp" data-wow-delay=".4s">
                        <div class="row">
                            <div class="col-lg-5 col-12">
                                <!-- Image -->
                                <div class="image">
                                    <img src="assets/images/team/shahzad.jpeg" alt="#">
                                </div>
                                <!-- End Image -->
                            </div>
                            <div class="col-lg-7 col-12">
                    ...
                    <div class="single-team wow fadeInUp" data-wow-delay=".4s">
                        <div class="row">
                            <div class="col-lg-5 col-12">
                                <!-- Image -->
                                <div class="image">
                                    <img src="assets/images/team/Miss-Malook.jpeg" alt="#">
                                </div>
                                <!-- End Image -->
                            </div>
                            <div class="col-lg-7 col-12">
                ...
                <!--            <div class="col-lg-5 col-12">-->
                                <!-- Image -->
                <!--                <div class="image">-->
                <!--                    <img src="assets/images/team/Gorav.jpeg" alt="#">-->
                <!--                </div>-->
                                <!-- End Image -->
                <!--            </div>-->
                <!--            <div class="col-lg-7 col-12">-->
            ...
            <div class="row testimonial-slider">
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-testimonial">
                        ...
                        <div class="author">
                            <img src="assets/images/testimonials/zaheer.jpg" alt="#">
                            <h4 class="name">
                                Zaheer Ali Buriro
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-testimonial">
                        ...
                        <div class="author">
                            <img src="assets/images/testimonials/shakeel.jpg" alt="#">
                            <h4 class="name">
                                Shakeel Akbar 
                                <span class="deg">Web Development</span>
                                <span class="deg">Student</span>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-testimonial">
                        ...
                        <div class="author">
                            <img src="assets/images/st/fayaz.jpg" alt="#">
                            <h4 class="name">
                                Fayyaz Ahmed Soomro
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-testimonial">
                        ...
                        <div class="author">
                            <img src="assets/images/st/mashoq.jpg" alt="#">
                            <h4 class="name">
            ...
            <div class="client-logo-wrapper">
                <div class="client-logo-carousel d-flex align-items-center justify-content-between">
                    <div class="client-logo">
                        <img src="assets/images/clients/ttb.png" alt="">
                    </div>
                    <div class="client-logo">
                        <img src="assets/images/clients/bbsydp.png" alt="">
                    </div>
                    <div class="client-logo">
                        <img src="assets/images/clients/ttb.png" alt="">
                    </div>
                    <div class="client-logo">
                        <img src="assets/images/clients/navttc.png" alt="">
                    </div>
                    <div class="client-logo">
                        <img src="assets/images/clients/stevta.png" alt="">
                    </div>
                    <div class="client-logo">
                        <img src="assets/images/clients/sindh.png" alt="">
                    </div>
                    <div class="client-logo">
                        <img src="assets/images/clients/IT.png" alt="">
                    </div>
    ...
    <!-- Start Contact Area -->
    <section id="contact-us" class="contact-us section" style="margin-top: -100px;">
        <div class="container" >
            <div class="row">
                <div class="col-12">
                    <div class="section-title align-center gray-bg">
                        ...
                        <p class="wow fadeInUp" data-wow-delay=".6s" style="color: lightgray;background-color: #012169;border-radius: 2px;">Have questions about our IT training programs, computer courses, or enrollment process? Connect with the DSIMT team today! Whether you're a student, parent, or professional, we’re ready to assist you with guidance, support, or partnership opportunities.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-12">
                    <div class="contact-info">
                        ...
                        <div class="single-info">
                            ...
                            <h4>E-mail Us</h4>
                            <p class="no-margin-bottom"><a href="mailto:info@yourdomain.com">www.dsimt.com</a>
