...
$title = "Our DSIMT All Events in Hyderabad,Sindh | Workshops & Seminars";
$description = "Stay updated with DSIMT events in Hyderabad Sindh. Join workshops, seminars, and training sessions designed to boost IT and digital skills.";
$keywords = null;
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-event wow fadeInUp" data-wow-delay=".2s">
                        <div class="event-image">
                            <a href="javascript:void(0)"><img src="assets/images/dsimt_imgs/inaug.jpg" alt="#"></a>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-event wow fadeInUp" data-wow-delay=".2s">
                        <div class="event-image">
                            <a href="javascript:void(0)"><img src="assets/images/dsimt_imgs/wall2.jpg" alt="#"></a>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-event wow fadeInUp" data-wow-delay=".2s">
                        <div class="event-image">
                            <a href="javascript:void(0)"><img style="height: 250px; width: 400px;" src="assets/images/events/cricket.jpg" alt="#"></a>
                        ...
                        <div class="bottom-content">
                            <a class="speaker" href="javascript:void(0)">
                                <img src="assets/images/events/cricket.jpg" alt="#">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-event wow fadeInUp" data-wow-delay=".4s">
                        <div class="event-image">
                            <a href="javascript:void(0)"><img class="image" src="assets/images/events/shafique.JPG" alt="#"></a>
                        ...
                        <div class="bottom-content">
                            <a class="speaker" href="javascript:void(0)">
                                <img src="assets/images/dsimt_imgs/ceo.png" alt="#">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-event wow fadeInUp" data-wow-delay=".4s">
                        <div class="event-image">
                            <a href="javascript:void(0)"><img class="image" src="assets/images/dsimt_imgs/bd.jpg" alt="#"></a>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-event wow fadeInUp" data-wow-delay=".4s">
                        <div class="event-image">
                            <a href="javascript:void(0)"><img class="image" src="assets/images/events/Trip Anouncement.png" alt="#"></a>
