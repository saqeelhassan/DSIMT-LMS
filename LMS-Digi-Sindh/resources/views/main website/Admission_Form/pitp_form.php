<?php
$conn = mysqli_connect("localhost", "dsimtedu_AdminDB", "DSIMT@admin", "dsimtedu_DSIMTDB");
...
<body>
    <div class="container-fluid">
        <div class="col-lg-3 col-md-6 col-sm-12">
            <a href="../index.php"><img src="assets/images/logo/logo1.png" class="mt-5" alt="" width="100%"></a>
        </div>
        ...
        <!--<h4 class="mt-3 text-center wow bounce" data-wow-delay=".2s">-->
                            ...
                            <div class="form-head">
                                ...
                                <form action="#" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" name="qualification" aria-label="Default select example" id="qualification" required>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-sm-12 form-group">
                                            ...
                                            <select class="form-select" name="domicile" aria-label="Default select example" id="" required>
        ...
        <div class="modal-dialog">
            <div class="modal-content w-75">
                ...
                <div class="modal-body">
                    ...
                    <b><a href="https://whatsapp.com/channel/0029Vb6pulW7YSd4fV8AGe2H">Join our WhatsApp Channel</a></b>
                </div>
                <div class="modal-footer">
                    <a type="button" class="btn btn-success" href="https://whatsapp.com/channel/0029Vb6pulW7YSd4fV8AGe2H"" data-bs-dismiss="modal">OK</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    const courses = {
        Matriculation: ["DIT", "E_Commerce", "Social_Media_Management"],
        Intermediate: ["Cyber_Security","Data_Science", "DIT", "E_Commerce", "Social_Media_Management"],
        UnderGraduate: ["Cyber_Security","Data_Science", "DIT", "E_Commerce", "Social_Media_Management"],
        Graduated: ["Cyber_Security","Data_Science", "DIT", "E_Commerce", "Social_Media_Management"],
    };
    ...
    const course_time = {
        cyber_security : "12PM to 03PM",
        data_science: "03PM to 06PM",
        social_media_management : "09AM to 12PM",
        e_commerce : "06PM to 09PM",
        dit : "Paid"
    };

    const time = document.getElementById("time");
    const course_slots = document.getElementById("course");

    course_slots.addEventListener("change", function(){
        let selectedCourse = this.value;

        if(selectedCourse && course_time[selectedCourse]){
            if(selectedCourse == "dit"){
                time.textContent = course_time[selectedCourse];
