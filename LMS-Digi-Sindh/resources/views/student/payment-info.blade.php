    ...
    <div class="card bg-transparent border rounded-3 mb-4 z-index-9">
        ...
        <div class="card-header bg-transparent d-sm-flex justify-content-sm-between align-items-center border-bottom">
            ...
            <a href="#" class="btn btn-sm btn-primary-soft mb-0" data-bs-toggle="modal"
                data-bs-target="#addNewcard">Add new card</a>
        </div>
        <!-- Card header END -->
                            ...
                            <form class="row text-start g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="position-relative">
                                        ...
                                        <img src="/images/client/visa.svg"
                        ...
                        <div class="accordion-body">
                            ...
                            <form class="row text-start g-3">
                                <p class="mb-1">In order to complete your transaction, we will
                                    transfer you over to Digital Sindh secure servers.</p>
                                <p class="my-0">Select your bank from the drop-down list and click
                                    proceed to continue with your payment.</p>
                                <!-- Select bank -->
                                <div class="col-md-6">
                ...
                <table class="table table-dark-gray align-middle p-4 mb-0 table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <!-- Title item -->
                            <td>
                                <h6 class="mt-2 mt-lg-0 mb-0"><a href="#">Sketch from A to Z:
                                        for app designer</a></h6>
                            </td>

                            <!-- Payment method item -->
                            <td><img src="/images/client/mastercard.svg" class="h-40px" alt=""><span
                        ...
                        <tr>
                            ...
                            <!-- Title item -->
                            <td>
                                <h6 class="mt-2 mt-lg-0 mb-0"><a href="#">Create a Design System
                                        in Figma</a></h6>
                            </td>
                        ...
                        <tr>
                            ...
                            <!-- Payment method item -->
                            <td><img src="/images/client/paypal.svg" class="w-80px" alt="">
                            </td>
                ...
                <form class="row text-start g-3">
                    ...
                    <div class="col-md-12">
                        <div class="form-check mb-0">
                            ...
                            <label class="form-check-label" for="exampleCheck1">Secuarely save card and
                                details</label>
                        </div>
                    </div>
                </form>
