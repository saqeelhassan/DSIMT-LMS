        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8 col-xl-6">
                    <h2 class="mb-1">Sign up as Student</h2>
                    <p class="text-body mb-4">Create your account to enroll in courses. All fields marked * are required.</p>
                    ...
                    <form method="post" action="{{ route('auth.register.student') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row g-3">
                            <div class="col-md-6">
                        ...
                        <div class="mb-4 mt-4">
                            <label for="course_id" class="form-label">Course (LMS)</label>
                            ...
                            @if(empty($courses) || $courses->isEmpty())
                                <p class="small text-body mb-0 mt-1">No courses available at the moment.</p>
                            @endif
                        </div>
                        ...
                        <div class="d-grid">
                            <button class="btn btn-primary mb-0" type="submit">Sign up as Student</button>
                        </div>
                    </form>
