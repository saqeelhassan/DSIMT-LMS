@extends('layouts.landing', ['ulClass' => 'me-auto', 'magaMenu' => true, 'headerClass' => 'header-static', 'containerClass' => '-fluid px-3 px-xl-5', 'category' => true])
            ...
            <div class="row align-items-center g-5">
                ...
                <div class="col-lg-7 col-xl-6 text-center position-relative">
                    ...
                    <div
                        ...
                        <img src="/images/client/science.svg" alt="Icon">
                    </div>
                    <div class="p-2 bg-white shadow rounded-3 position-absolute top-0 end-0 me-5">
                        <img src="/images/client/angular.svg" alt="Icon">
                    </div>
                    <div
                        ...
                        <img src="/images/client/figma.svg" alt="Icon">
                    </div>
                    <!-- Icon logos END -->
                    ...
                    <div class="p-3 bg-success d-inline-block rounded-4 shadow-lg position-absolute top-50 end-0 translate-middle-y mt-n7 z-index-1 d-none d-md-block"
                        style="background:url(/images/pattern/01.png) no-repeat center center; background-size:cover;">
                        <p class="text-white">Our daily new students</p>
                        <!-- Avatar group -->
                        <ul class="avatar-group mb-0">
                            <li class="avatar avatar-sm">
                                <img class="avatar-img rounded-circle border-white" src="/images/avatar/01.jpg"
                                    alt="avatar">
                            </li>
                            <li class="avatar avatar-sm">
                                <img class="avatar-img rounded-circle border-white" src="/images/avatar/02.jpg"
                                    alt="avatar">
                            </li>
                            <li class="avatar avatar-sm">
                                <img class="avatar-img rounded-circle border-white" src="/images/avatar/03.jpg"
                                    alt="avatar">
                            </li>
                            <li class="avatar avatar-sm">
                                <img class="avatar-img rounded-circle border-white" src="/images/avatar/04.jpg"
                                    alt="avatar">
                            </li>
                            <li class="avatar avatar-sm">
                    ...
                    <div class="position-relative ms-sm-4">
                        <img src="/images/element/07.png" alt="">
                    </div>
                </div>
                <!-- Right content END -->
            </div>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="d-flex justify-content-center align-items-center p-4 bg-info bg-opacity-10 rounded-3">
                        ...
                        <div class="ms-4 h6 fw-normal mb-0">
                            <div class="d-flex">
                                <h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0"
                                    data-purecounter-end="6" data-purecounter-delay="300">0</h5>
                                <span class="mb-0 h5">K+</span>
                            </div>
            ...
            <div class="tab-content" id="course-pills-tabContent">
                ...
                <div class="tab-pane fade show active" id="course-pills-tabs-1" role="tabpanel"
                    ...
                    <div class="row g-4">
                                ...
                                <div class="col-sm-6 col-lg-4 col-xl-3">
                                    <div class="card shadow h-100">
                                        ...
                                        <div class="card-body pb-0">
                                            ...
                                            <h5 class="card-title fw-normal"><a href="{{ route('courses.detail', $course) }}">{{ $course->name }}</a></h5>
                                            <p class="mb-2 text-truncate-2">{{ Str::limit($course->description, 60) ?: 'No description.' }}</p>
                                            <ul class="list-inline mb-0">
                                                <li class="list-inline-item ms-2 h6 fw-light mb-0">{{ $course->enrollments_count ?? 0 }} enrolled</li>
                                            </ul>
                                        </div>
                                        <div class="card-footer pt-0 border-0">
                                            <a href="{{ route('courses.detail', $course) }}" class="btn btn-sm btn-primary-soft mb-0">View course</a>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                        ...
                        @else
                        <!-- Card item START (fallback when no DB courses) -->
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="card shadow h-100">
                                <!-- Image -->
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="card shadow h-100">
                                ...
                                <div class="card-body pb-0">
                                    ...
                                    <!-- Title -->
                                    <h5 class="card-title fw-normal"><a href="#">Graphic Design Masterclass</a>
                                    </h5>
                                    <p class="mb-2 text-truncate-2">Rooms oh fully taken by worse do Points afraid but
                                        may end Rooms Points afraid but may end Rooms</p>
                                    <!-- Rating star -->
                                    <ul class="list-inline mb-0">
                                        <li class="list-inline-item me-0 small"><i
                                                class="fas fa-star text-warning"></i></li>
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="card shadow h-100">
                                ...
                                <div class="card-body pb-0">
                                    ...
                                    <!-- Title -->
                                    <h5 class="card-title fw-normal"><a href="#">Create a Design System in
                                            Figma</a></h5>
                                    <p class="mb-2 text-truncate-2">Rooms oh fully taken by worse do. Points afraid but
                                        may end afraid but may end.</p>
                                    <!-- Rating star -->
                                    <ul class="list-inline mb-0">
                                        <li class="list-inline-item me-0 small"><i
                                                class="fas fa-star text-warning"></i></li>
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="card shadow h-100">
                                ...
                                <div class="card-body pb-0">
                                    ...
                                    <p class="mb-2 text-truncate-2">Far advanced settling say finished raillery.
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="card shadow h-100">
                                ...
                                <div class="card-body pb-0">
                                    ...
                                    <!-- Title -->
                                    <h5 class="card-title fw-normal"><a href="#">Build Websites with CSS</a>
                                    </h5>
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="card shadow h-100">
                                <!-- Image -->
                                <img src="/images/courses/4by3/09.jpg" class="card-img-top" alt="course image">
                                <div class="card-body pb-0">
                                    <!-- Badge and favorite -->
                                    <div class="d-flex justify-content-between mb-2">
                                        <a href="#" class="badge bg-purple bg-opacity-10 text-purple">All
                                ...
                                <div class="card-footer pt-0 pb-3">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <span class="h6 fw-light mb-0"><i
                                                class="far fa-clock text-danger me-2"></i>35h 20m</span>
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="card shadow h-100">
                                ...
                                <div class="card-body pb-0">
                                    ...
                                    <!-- Title -->
                                    <h5 class="card-title fw-normal"><a href="#">Angular – The Complete
                                            Guider</a></h5>
                                    <p class="text-truncate-2 mb-2">Rooms oh fully taken by worse do. Points afraid but
                                        may end.</p>
                                    <!-- Rating star -->
                                    <ul class="list-inline mb-0">
                                        <li class="list-inline-item me-0 small"><i
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="card shadow">
                                ...
                                <div class="card-body pb-0">
                                    ...
                                    <!-- Title -->
                                    <h5 class="card-title fw-normal"><a href="#">Deep Learning with
                                            React-Native</a></h5>
                                    <p class="text-truncate-2 mb-2">Far advanced settling say finished raillery.
                                        Offered chiefly farther</p>
                                    <!-- Rating star -->
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="card shadow h-100">
                                ...
                                <div class="card-body pb-0">
                                    ...
                                    <!-- Title -->
                                    <h5 class="card-title fw-normal"><a href="#">Bootstrap 5 From Scratch</a>
                                    </h5>
                                    <p class="text-truncate-2 mb-2">Far advanced settling say finished raillery.
                                        Offered chiefly farther</p>
                                    <!-- Rating star -->
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="card shadow h-100">
                                ...
                                <div class="card-body pb-0">
                                    ...
                                    <!-- Title -->
                                    <h5 class="card-title fw-normal"><a href="#">Digital Marketing
                                            Masterclass</a></h5>
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="card shadow h-100">
                                ...
                                <div class="card-body pb-0">
                                    ...
                                    <!-- Title -->
                                    <h5 class="card-title fw-normal"><a href="#">Learn Invision</a></h5>
                                    <p class="text-truncate-2 mb-2">Arrived off she elderly beloved him Course regard
                                        to up he hardly.</p>
                                    <!-- Rating star -->
                                    <ul class="list-inline mb-0">
                                        <li class="list-inline-item me-0 small"><i
                                ...
                                <div class="card-footer pt-0 pb-3">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <span class="h6 fw-light mb-0"><i
                                                class="far fa-clock text-danger me-2"></i>35h 20m</span>
                                        <span class="h6 fw-light mb-0"><i
                                                class="fas fa-table text-orange me-2"></i>89 lectures</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-11 mx-auto position-relative">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-5 text-lg-end">
                                        <a href="#" class="btn btn-outline-warning mb-0">Start Teaching
                                            Today</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tiny-slider-inner pb-1" data-autoplay="true" data-arrow="true" data-edge="2"
                        ...
                        <div>
                            <div class="card action-trigger-hover border bg-transparent">
                                <!-- Image -->
                                <img src="/images/courses/4by3/14.jpg" class="card-img-top" alt="course image">
                                <!-- Ribbon -->
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm">
                                                <img class="avatar-img rounded-1" src="/images/avatar/10.jpg"
                                                    alt="avatar">
                                            </div>
                        ...
                        <div>
                            <div class="card action-trigger-hover border bg-transparent">
                                <!-- Image -->
                                <img src="/images/courses/4by3/15.jpg" class="card-img-top" alt="course image">
                                <!-- Card body -->
                                <div class="card-body pb-0">
                                    <!-- Badge and favorite -->
                                    <div class="d-flex justify-content-between mb-3">
                                ...
                                <div class="card-footer pt-0 bg-transparent">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm">
                                                <img class="avatar-img rounded-1" src="/images/avatar/04.jpg"
                                                    alt="avatar">
                                            </div>
                        ...
                        <div>
                            <div class="card action-trigger-hover border bg-transparent">
                                <!-- Image -->
                                <img src="/images/courses/4by3/17.jpg" class="card-img-top" alt="course image">
                                <!-- Card body -->
                                <div class="card-body pb-0">
                                    <!-- Badge and favorite -->
                                    <div class="d-flex justify-content-between mb-3">
                                    ...
                                    <div class="hstack gap-3">
                                        ...
                                        <span class="h6 fw-light mb-0"><i
                                                class="fas fa-table text-orange me-2"></i>55 lectures</span>
                                    </div>
                                </div>
                                <!-- Card footer -->
                                <div class="card-footer pt-0 bg-transparent">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm">
                                                <img class="avatar-img rounded-1" src="/images/avatar/09.jpg"
                                                    alt="avatar">
                                            </div>
                        ...
                        <div>
                            <div class="card action-trigger-hover border bg-transparent">
                                <!-- Image -->
                                <img src="/images/courses/4by3/16.jpg" class="card-img-top" alt="course image">
                                <!-- Card body -->
                                <div class="card-body pb-0">
                                    <!-- Badge and favorite -->
                                    <div class="d-flex justify-content-between mb-3">
                                    ...
                                    <div class="hstack gap-3">
                                        ...
                                        <span class="h6 fw-light mb-0"><i
                                                class="fas fa-table text-orange me-2"></i>21 lectures</span>
                                    </div>
                                </div>
                                <!-- Card footer -->
                                <div class="card-footer pt-0 bg-transparent">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm">
                                                <img class="avatar-img rounded-1" src="/images/avatar/01.jpg"
                                                    alt="avatar">
                                            </div>
                        ...
                        <div class="col-md-5 mt-5 mt-md-0 d-none d-md-block">
                            <div class="bg-body shadow p-4 rounded-3 d-inline-block position-relative">
                                ...
                                <div class="d-flex align-items-center">
                                    <!-- Avatar -->
                                    <div class="avatar avatar-sm">
                                        <img class="avatar-img rounded-1" src="/images/avatar/02.jpg"
                                            alt="avatar">
                                    </div>
                                    <!-- Info -->
                                    <div class="ms-2">
                    ...
                    <div class="row mt-5 mt-xl-0">
                        ...
                        <div class="col-7 mt-0 mt-xl-5 text-end position-relative z-index-1 d-none d-md-block">
                            ...
                            <div class="p-3 bg-primary d-inline-block rounded-4 shadow-lg text-center"
                                style="background:url(/images/pattern/02.png) no-repeat center center; background-size:cover;">
                                <!-- Info -->
        ...
        <div class="py-3">
            <div class="container px-0">
                <div class="d-lg-flex justify-content-between align-items-center py-3 text-center text-md-left">
                    <!-- copyright text -->
                    <div class="text-body text-primary-hover"> Copyrights ©2025 Digital Sindh Institute of Management & Technology
                    </div>
                    <!-- copyright links-->
